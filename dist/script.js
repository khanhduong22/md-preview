...
This is a fully client-side application. Your content never leaves your browser and stays secure on your device.`,Re=`# Project Master Overview: App Master
...
\`\`\`
`;async function ze(){try{let e=await localforage.getItem(g);return e?typeof e==`string`?JSON.parse(e):e:[]}catch{return[]}}function M(e){try{localforage.setItem(g,e)}catch(e){console.warn(`Failed to save AppState.tabs to localforage:`,e)}}async function Be(){return await localforage.getItem(_)}function N(e){localforage.setItem(_,e)}async function Ve(){let e=await localforage.getItem(v);return parseInt(e||`0`,10)}function He(e){localforage.setItem(v,String(e))}function Ue(){return x.untitledCounter=(x.untitledCounter||0)+1,He(x.untitledCounter),`Untitled `+x.untitledCounter}var P=[{name:`gray`,bg:`rgba(156,163,175,0.25)`,border:`#9ca3af`,dot:`#9ca3af`},{name:`blue`,bg:`rgba(59,130,246,0.2)`,border:`#3b82f6`,dot:`#3b82f6`},{name:`purple`,bg:`rgba(168,85,247,0.2)`,border:`#a855f7`,dot:`#a855f7`},{name:`green`,bg:`rgba(34,197,94,0.2)`,border:`#22c55e`,dot:`#22c55e`},{name:`yellow`,bg:`rgba(234,179,8,0.25)`,border:`#eab308`,dot:`#eab308`},{name:`orange`,bg:`rgba(249,115,22,0.2)`,border:`#f97316`,dot:`#f97316`},{name:`red`,bg:`rgba(239,68,68,0.2)`,border:`#ef4444`,dot:`#ef4444`},{name:`pink`,bg:`rgba(236,72,153,0.2)`,border:`#ec4899`,dot:`#ec4899`}];async function We(){try{let e=await localforage.getItem(y);return e?JSON.parse(e):[]}catch{return[]}}function F(){localforage.setItem(y,JSON.stringify(x.tabGroups))}function Ge(e,t){let n=P.find(e=>e.name===t)||P[2],r={id:`grp_`+Date.now()+`_`+Math.random().toString(36).slice(2,6),name:e||`New Group`,color:n.name,collapsed:!1};return x.tabGroups.push(r),F(),r}function Ke(e){x.tabs.forEach(t=>{t.groupId===e&&(t.groupId=null)}),x.tabGroups=x.tabGroups.filter(t=>t.id!==e),F(),M(x.tabs),L(x.tabs,x.activeTabId)}function qe(e){let t=x.tabGroups.find(t=>t.id===e);if(!t)return;let n=prompt(`Rename group:`,t.name);n!==null&&(t.name=n.trim()||`Unnamed`,F(),L(x.tabs,x.activeTabId))}function Je(e){let t=x.tabGroups.find(t=>t.id===e);t&&(t.collapsed=!t.collapsed,F(),L(x.tabs,x.activeTabId))}function Ye(e,t){let n=x.tabGroups.find(t=>t.id===e);n&&(n.color=t,F(),L(x.tabs,x.activeTabId))}function Xe(e,t){let n=x.tabs.find(t=>t.id===e);n&&(n.groupId=t,M(x.tabs),L(x.tabs,x.activeTabId))}function Ze(e){let t=x.tabs.find(t=>t.id===e);t&&(t.groupId=null,M(x.tabs),L(x.tabs,x.activeTabId))}function Qe(e){return P.find(t=>t.name===e)||P[0]}x.tabGroups=We();function I(e,t,n){return e===void 0&&(e=``),t===void 0&&(t=null),n===void 0&&(n=`split`),{id:`tab_`+Date.now()+`_`+Math.random().toString(36).substring(2,8),title:t||`Untitled`,content:e,scrollPos:0,viewMode:n,createdAt:Date.now()}}function L(e,t){let n=document.getElementById(`tab-list`);if(!n)return;n.replaceChildren();function r(e){let t=`<div class="tab-group-submenu">`;return t+=`<button class="tab-menu-item" data-action="new-group"><i class="bi bi-folder-plus"></i> New Group</button>`,x.tabGroups.length>0&&(t+=`<div class="tab-ctx-divider"></div>`,x.tabGroups.forEach(n=>{let r=Qe(n.color),i=e===n.id?` ✓`:``;t+=`<button class="tab-menu-item" data-action="add-to-group" data-group-id="`+n.id+`"><span class="group-color-dot" style="background:`+r.dot+`"></span> `+(n.name||`Unnamed`)+i+`</button>`})),e&&(t+=`<div class="tab-ctx-divider"></div>`,t+=`<button class="tab-menu-item" data-action="remove-from-group"><i class="bi bi-folder-minus"></i> Remove from Group</button>`),t+=`</div>`,t}function i(e,n){let i=document.createElement(`div`);i.className=`tab-item`+(e.id===t?` active`:``),n&&(i.style.borderBottomColor=n.border,i.classList.add(`in-group`)),i.setAttribute(`data-tab-id`,e.id),i.setAttribute(`role`,`tab`),i.setAttribute(`aria-selected`,e.id===t?`true`:`false`),i.setAttribute(`draggable`,`true`);let a=document.createElement(`span`);a.className=`tab-title`,a.textContent=e.title||`Untitled`,a.ondblclick=n=>{n.stopPropagation(),startInlineRename(a,e.title||`Untitled`,async n=>{n&&n!==e.title?(x.localVaultMode&&e.handle&&(e.id.split(`/`).pop(),e.handle,e.id,x.vaultDirHandle),e.title=n,M(x.tabs),L(x.tabs,t)):L(x.tabs,t)})},a.title=e.title||`Untitled`;let o=document.createElement(`button`);o.className=`tab-menu-btn`,o.setAttribute(`aria-label`,`File options`),o.title=`File options`,o.textContent=`⋯`;let s=document.createElement(`div`);s.className=`tab-menu-dropdown`,s.replaceChildren(),s.insertAdjacentHTML(`beforeend`,`<button class="tab-menu-item" data-action="pin"><i class="bi bi-pin"></i> <span class="pin-label">`+(e.pinned?`Unpin`:`Pin`)+`</span></button><button class="tab-menu-item" data-action="tag"><i class="bi bi-tag"></i> Tag</button><button class="tab-menu-item tab-menu-item-has-sub" data-action="group-menu"><i class="bi bi-collection"></i> Group <i class="bi bi-chevron-right" style="font-size:10px;margin-left:auto"></i></button><div class="tab-ctx-divider"></div><button class="tab-menu-item" data-action="rename"><i class="bi bi-pencil"></i> Rename</button><button class="tab-menu-item" data-action="duplicate"><i class="bi bi-files"></i> Duplicate</button><button class="tab-menu-item tab-menu-item-danger" data-action="delete"><i class="bi bi-trash"></i> Delete</button>`);let c=document.createElement(`div`);c.className=`tab-group-sub-container`,c.style.display=`none`,c.replaceChildren(),c.insertAdjacentHTML(`beforeend`,r(e.groupId)),s.appendChild(c),o.appendChild(s);let l=s.querySelector(`[data-action="group-menu"]`);return l&&(l.addEventListener(`mouseenter`,()=>{c.style.display=`block`;let e=l.getBoundingClientRect();c.style.top=e.top+`px`,c.style.left=e.left-8+`px`}),l.addEventListener(`click`,e=>{e.stopPropagation(),c.style.display=c.style.display===`none`?`block`:`none`})),s.addEventListener(`mouseleave`,()=>{c.style.display=`none`}),c.querySelectorAll(`.tab-menu-item`).forEach(t=>{t.addEventListener(`click`,n=>{n.stopPropagation(),o.classList.remove(`open`);let r=t.dataset.action;if(r===`new-group`){let t=prompt(`Group name:`);if(t===null)return;let n=Ge(t,`purple`);Xe(e.id,n.id)}else r===`add-to-group`?Xe(e.id,t.dataset.groupId):r===`remove-from-group`&&Ze(e.id)})}),o.addEventListener(`click`,function(e){if(e.stopPropagation(),document.querySelectorAll(`.tab-menu-btn.open`).forEach(function(e){e!==o&&e.classList.remove(`open`)}),o.classList.toggle(`open`),o.classList.contains(`open`)){var t=o.getBoundingClientRect();s.style.top=t.bottom+4+`px`,s.style.right=window.innerWidth-t.right+`px`,s.style.left=`auto`}}),s.querySelectorAll(`:scope > .tab-menu-item`).forEach(function(t){t.addEventListener(`click`,function(n){n.stopPropagation();let r=t.dataset.action;r!==`group-menu`&&(o.classList.remove(`open`),r===`rename`?nt(e.id):r===`duplicate`?rt(e.id):r===`delete`?tt(e.id):r===`pin`?ot(e.id):r===`tag`&&promptTagTab(e.id))})}),i.appendChild(a),i.appendChild(o),i.addEventListener(`click`,function(){z(e.id)}),i.addEventListener(`dragstart`,function(){draggedTabId=e.id,setTimeout(function(){i.classList.add(`dragging`)},0)}),i.addEventListener(`dragend`,function(){i.classList.remove(`dragging`),draggedTabId=null}),i.addEventListener(`dragover`,function(e){e.preventDefault(),i.classList.add(`drag-over`)}),i.addEventListener(`dragleave`,function(){i.classList.remove(`drag-over`)}),i.addEventListener(`drop`,function(t){if(t.preventDefault(),i.classList.remove(`drag-over`),!draggedTabId||draggedTabId===e.id)return;let n=x.tabs.findIndex(e=>e.id===draggedTabId),r=x.tabs.findIndex(t=>t.id===e.id);if(n===-1||r===-1)return;let a=x.tabs.splice(n,1)[0];e.groupId&&(a.groupId=e.groupId),x.tabs.splice(r,0,a),M(x.tabs),L(x.tabs,x.activeTabId)}),i}function a(e){let t=Qe(e.color),n=document.createElement(`div`);return n.className=`tab-group-header`+(e.collapsed?` collapsed`:``),n.style.setProperty(`--group-color`,t.border),n.style.setProperty(`--group-bg`,t.bg),n.setAttribute(`data-group-id`,e.id),n.replaceChildren(),n.insertAdjacentHTML(`beforeend`,`<span class="group-color-dot" style="background:`+t.dot+`"></span><span class="group-header-name">`+(e.name||`Unnamed`)+`</span><span class="group-collapse-icon"><i class="bi bi-chevron-`+(e.collapsed?`right`:`down`)+`"></i></span>`),n.addEventListener(`click`,t=>{t.stopPropagation(),Je(e.id)}),n.addEventListener(`dblclick`,t=>{t.stopPropagation(),qe(e.id)}),n.addEventListener(`contextmenu`,t=>{t.preventDefault(),t.stopPropagation(),document.querySelectorAll(`.group-context-menu`).forEach(e=>e.remove());let n=document.createElement(`div`);n.className=`group-context-menu`,n.replaceChildren(),n.insertAdjacentHTML(`beforeend`,`<button data-action="rename"><i class="bi bi-pencil"></i> Rename</button><div class="tab-ctx-divider"></div><div class="group-color-picker">`+P.map(t=>`<span class="group-color-option`+(t.name===e.color?` active`:``)+`" data-color="`+t.name+`" style="background:`+t.dot+`"></span>`).join(``)+`</div><div class="tab-ctx-divider"></div><button class="tab-menu-item-danger" data-action="ungroup"><i class="bi bi-folder-minus"></i> Ungroup All</button><button class="tab-menu-item-danger" data-action="delete-group"><i class="bi bi-trash"></i> Delete Group</button>`),n.style.position=`fixed`,n.style.top=t.clientY+`px`,n.style.left=t.clientX+`px`,document.body.appendChild(n),n.querySelectorAll(`button`).forEach(t=>{t.addEventListener(`click`,r=>{r.stopPropagation(),n.remove();let i=t.dataset.action;i===`rename`?qe(e.id):i===`ungroup`?Ke(e.id):i===`delete-group`&&(x.tabs.filter(t=>t.groupId===e.id).forEach(e=>tt(e.id)),x.tabGroups=x.tabGroups.filter(t=>t.id!==e.id),F(),L(x.tabs,x.activeTabId))})}),n.querySelectorAll(`.group-color-option`).forEach(t=>{t.addEventListener(`click`,r=>{r.stopPropagation(),n.remove(),Ye(e.id,t.dataset.color)})});let r=()=>{n.remove(),document.removeEventListener(`click`,r)};setTimeout(()=>document.addEventListener(`click`,r),0)}),n.addEventListener(`dragover`,e=>{e.preventDefault(),n.classList.add(`drag-over`)}),n.addEventListener(`dragleave`,()=>{n.classList.remove(`drag-over`)}),n.addEventListener(`drop`,t=>{t.preventDefault(),n.classList.remove(`drag-over`),draggedTabId&&Xe(draggedTabId,e.id)}),n}x.tabGroups.forEach(t=>{let r=e.filter(e=>e.groupId===t.id);if(r.length===0)return;let o=Qe(t.color);n.appendChild(a(t)),t.collapsed||r.forEach(e=>{n.appendChild(i(e,o))})}),e.filter(e=>!e.groupId||!x.tabGroups.some(t=>t.id===e.groupId)).forEach(e=>{n.appendChild(i(e,null))});let o=document.createElement(`button`);o.className=`tab-new-btn`,o.title=`New Tab (Ctrl+T)`,o.setAttribute(`aria-label`,`Open new tab`),o.replaceChildren();let s=document.createElement(`i`);s.className=`bi bi-plus-lg`,o.appendChild(s),o.addEventListener(`click`,function(){B()}),n.appendChild(o);let c=n.querySelector(`.tab-item.active`);c&&c.scrollIntoView({block:`nearest`,inline:`nearest`}),$e(e,t)}function $e(e,t){let n=document.getElementById(`mobile-tab-list`);n&&(n.replaceChildren(),e.forEach(function(e){let r=document.createElement(`div`);r.className=`mobile-tab-item`+(e.id===t?` active`:``),r.setAttribute(`role`,`tab`),r.setAttribute(`aria-selected`,e.id===t?`true`:`false`),r.setAttribute(`data-tab-id`,e.id);let i=document.createElement(`span`);i.className=`mobile-tab-title`,i.textContent=e.title||`Untitled`,i.title=e.title||`Untitled`;let a=document.createElement(`button`);a.className=`tab-menu-btn`,a.setAttribute(`aria-label`,`File options`),a.title=`File options`,a.textContent=`⋯`;let o=document.createElement(`div`);o.className=`tab-menu-dropdown`,o.replaceChildren(),o.insertAdjacentHTML(`beforeend`,`<button class="tab-menu-item" data-action="rename"><i class="bi bi-pencil"></i> Rename</button><button class="tab-menu-item" data-action="duplicate"><i class="bi bi-files"></i> Duplicate</button><button class="tab-menu-item tab-menu-item-danger" data-action="delete"><i class="bi bi-trash"></i> Delete</button>`),a.appendChild(o),a.addEventListener(`click`,function(e){if(e.stopPropagation(),document.querySelectorAll(`.tab-menu-btn.open`).forEach(function(e){e!==a&&e.classList.remove(`open`)}),a.classList.toggle(`open`),a.classList.contains(`open`)){let e=a.getBoundingClientRect();o.style.top=e.bottom+4+`px`,o.style.right=window.innerWidth-e.right+`px`,o.style.left=`auto`}}),o.querySelectorAll(`.tab-menu-item`).forEach(function(t){t.addEventListener(`click`,function(n){n.stopPropagation(),a.classList.remove(`open`);let r=t.getAttribute(`data-action`);r===`rename`?(closeMobileMenu(),nt(e.id)):r===`duplicate`?(rt(e.id),closeMobileMenu()):r===`delete`&&tt(e.id)})}),r.appendChild(i),r.appendChild(a),r.addEventListener(`click`,function(){z(e.id),closeMobileMenu()}),n.appendChild(r)}))}document.addEventListener(`click`,function(){document.querySelectorAll(`.tab-menu-btn.open`).forEach(function(e){e.classList.remove(`open`)})});async function R(e=!1){let t=x.tabs.find(function(e){return e.id===x.activeTabId});if(t)if(t.content=n.value,t.scrollPos=n.scrollTop,t.viewMode=O||`split`,t.handle&&e===!0)try{let e=await t.handle.createWritable();if(await e.write(t.content),await e.close(),x.vaultMiniSearch)try{let e={id:t.id,title:t.title,path:t.path,content:t.content};x.vaultMiniSearch.has(t.id)?x.vaultMiniSearch.replace(e):x.vaultMiniSearch.add(e)}catch(e){console.warn(`MiniSearch update error:`,e)}}catch(e){console.error(`Failed to write cleanly to vault:`,e)}else t.handle||M(x.tabs)}async function z(e){if(e===x.activeTabId&&!x.localVaultMode)return;await R(!0),x.activeTabId=e,N(x.activeTabId);let t=x.tabs.find(function(t){return t.id===e});if(t){if(t.handle)try{t.content=await(await t.handle.getFile()).text()}catch{t.content||=`Error reading file`}n.value=t.content||``,j(t.viewMode),W(),requestAnimationFrame(function(){n.scrollTop=t.scrollPos||0}),L(x.tabs,x.activeTabId)}}function B(e,t){e===void 0&&(e=``),t||=Ue();let r=I(e,t);r.createdAt=Date.now(),x.tabs.push(r),z(r.id),n.focus()}function et(e){let t=x.tabs.findIndex(function(t){return t.id===e});if(t!==-1){if(x.tabs.splice(t,1),x.tabs.length===0){let e=I(``,Ue());x.tabs.push(e),x.activeTabId=e.id,N(x.activeTabId),n.value=``,j(`split`),W()}else if(x.activeTabId===e){let e=Math.max(0,t-1);x.activeTabId=x.tabs[e].id,N(x.activeTabId);let r=x.tabs[e];n.value=r.content,j(r.viewMode),W(),requestAnimationFrame(function(){n.scrollTop=r.scrollPos||0})}M(x.tabs),L(x.tabs,x.activeTabId)}}function tt(e){et(e)}function nt(e){let t=x.tabs.find(function(t){return t.id===e});if(!t)return;let n=document.getElementById(`rename-modal`),r=document.getElementById(`rename-modal-input`),i=document.getElementById(`rename-modal-confirm`),a=document.getElementById(`rename-modal-cancel`);if(!n||!r)return;r.value=t.title,n.style.display=`flex`,r.focus(),r.select();function o(){let e=r.value.trim();e&&(t.title=e,M(x.tabs),L(x.tabs,x.activeTabId)),n.style.display=`none`,s()}function s(){i.removeEventListener(`click`,o),a.removeEventListener(`click`,c),r.removeEventListener(`keydown`,l)}function c(){n.style.display=`none`,s()}function l(e){e.key===`Enter`?o():e.key===`Escape`&&c()}i.addEventListener(`click`,o),a.addEventListener(`click`,c),r.addEventListener(`keydown`,l)}function rt(e){let t=x.tabs.find(function(t){return t.id===e});if(!t)return;R(!0);let n=t.title+` (copy)`,r=I(t.content,n,t.viewMode);t.groupId&&(r.groupId=t.groupId);let i=x.tabs.findIndex(function(t){return t.id===e});x.tabs.splice(i+1,0,r),z(r.id)}function it(){let e=document.getElementById(`reset-confirm-modal`),t=document.getElementById(`reset-modal-confirm`),r=document.getElementById(`reset-modal-cancel`),i=document.getElementById(`reset-modal-title`);if(!e)return;x.localVaultMode?(i.textContent=`Close all AppState.tabs? (Local files will NOT be deleted)`,t.textContent=`Close All`):(i.textContent=`Are you sure you want to delete all virtual files and reset to default?`,t.textContent=`Delete & Reset`),e.style.display=`flex`;function a(){if(e.style.display=`none`,s(),x.tabs=[],x.tabGroups=[],F(),x.untitledCounter=0,He(0),x.localVaultMode)x.activeTabId=null,n.value=``;else{let e=I(Le,`Welcome to Markdown`);if(x.tabs.push(e),Re!==void 0){let e=Ge(`demo`,`purple`),t=I(Re,`30 chart`);t.groupId=e.id,x.tabs.push(t)}x.activeTabId=e.id,n.value=Le}N(x.activeTabId),M(x.tabs),j(`split`),W(),L(x.tabs,x.activeTabId),window.history&&window.history.replaceState?window.history.replaceState(null,null,window.location.pathname):window.location.hash=``}function o(){e.style.display=`none`,s()}function s(){t.removeEventListener(`click`,a),r.removeEventListener(`click`,o)}t.addEventListener(`click`,a),r.addEventListener(`click`,o)}function at(){if(x.tabs=[],x.tabGroups=[],F(),x.localVaultMode)x.activeTabId=null,n.value=``;else{let e=I(``,Ue());x.tabs.push(e),x.activeTabId=e.id,n.value=``}N(x.activeTabId),M(x.tabs),j(`split`),W(),L(x.tabs,x.activeTabId)}function ot(e){let t=x.tabs.find(t=>t.id===e);t&&(t.pinned=!t.pinned,M(x.tabs),L(x.tabs,x.activeTabId))}function st(){let e=document.getElementById(`mobile-menu-panel`),t=document.getElementById(`mobile-menu-overlay`),n=document.getElementById(`mobile-menu-toggle`),r=document.getElementById(`mobile-close-menu`),i=document.getElementById(`mobile-toggle-vault`),a=document.getElementById(`mobile-toggle-sync`),o=document.getElementById(`mobile-import-btn`),s=document.getElementById(`mobile-export-md`),c=document.getElementById(`mobile-export-html`),l=document.getElementById(`mobile-export-pdf`),u=document.getElementById(`mobile-copy-markdown`),d=document.getElementById(`mobile-theme-toggle`),f=document.getElementById(`mobile-new-tab-btn`),p=document.getElementById(`mobile-close-all-tabs-btn`),m=document.getElementById(`mobile-tab-reset-btn`),h=document.querySelectorAll(`.mobile-view-mode-btn`),g=document.getElementById(`theme-toggle`),_=document.getElementById(`file-input`),v=document.getElementById(`export-md`),ee=document.getElementById(`export-html`),y=document.getElementById(`export-pdf`),b=document.getElementById(`copy-markdown-button`);function x(){e&&e.classList.add(`active`),t&&t.classList.add(`active`)}function S(){e&&e.classList.remove(`active`),t&&t.classList.remove(`active`)}n&&n.addEventListener(`click`,x),r&&r.addEventListener(`click`,S),t&&t.addEventListener(`click`,S),i&&i.addEventListener(`click`,()=>{let e=document.getElementById(`sidebar-explorer`);e&&e.classList.toggle(`mobile-active`),S()}),a&&a.addEventListener(`click`,()=>{Te(),E?(a.innerHTML=`<i class="bi bi-link me-2"></i> On`,a.classList.add(`sync-enabled`),a.classList.remove(`sync-disabled`,`border-primary`)):(a.innerHTML=`<i class="bi bi-link-45deg me-2"></i> Off`,a.classList.add(`sync-disabled`,`border-primary`),a.classList.remove(`sync-enabled`))}),o&&_&&o.addEventListener(`click`,()=>_.click()),s&&v&&s.addEventListener(`click`,()=>v.click()),c&&ee&&c.addEventListener(`click`,()=>ee.click()),l&&y&&l.addEventListener(`click`,()=>y.click()),u&&b&&u.addEventListener(`click`,()=>b.click()),d&&g&&d.addEventListener(`click`,()=>{g.click(),d.innerHTML=g.innerHTML+` Toggle Dark Mode`}),f&&f.addEventListener(`click`,function(){B(),S()}),p&&p.addEventListener(`click`,function(){S(),at()}),m&&m.addEventListener(`click`,function(){S(),it()}),h&&h.forEach(e=>{e.addEventListener(`click`,function(){Ee(this.getAttribute(`data-mode`)),R(),S()})})}function ct(){let e=document.getElementById(`mobile-char-count`),t=document.getElementById(`mobile-word-count`),n=document.getElementById(`mobile-reading-time`);e&&l&&(e.textContent=l.textContent),t&&c&&(t.textContent=c.textContent),n&&s&&(n.textContent=s.textContent)}function lt(e){let t=document.createTreeWalker(e,NodeFilter.SHOW_TEXT,null,!1),n=[],r;for(;r=t.nextNode();){let t=r.parentNode,i=!1;for(;t&&t!==e;){if(t.tagName===`PRE`||t.tagName===`CODE`){i=!0;break}t=t.parentNode}!i&&r.nodeValue.includes(`:`)&&n.push(r)}n.forEach(e=>{let t=e.nodeValue,n=/:([\w+-]+):/g,r,i=0,a=``,o=!1;for(;(r=n.exec(t))!==null;){let e=r[1],s=joypixels.shortnameToUnicode(`:${e}:`);s===`:${e}:`?(a+=t.substring(i,n.lastIndex),i=n.lastIndex):(o=!0,a+=t.substring(i,r.index)+s,i=n.lastIndex)}if(o){a+=t.substring(i);let n=document.createElement(`span`);n.innerHTML=a,e.parentNode.replaceChild(n,e)}})}function ut(e){let t=e.cloneNode(!0),n=e.getBoundingClientRect();t.getAttribute(`width`)||t.setAttribute(`width`,Math.round(n.width)),t.getAttribute(`height`)||t.setAttribute(`height`,Math.round(n.height));let r=new XMLSerializer().serializeToString(t);return`data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(r)))}`}function dt(e){return new Promise((t,n)=>{let r=document.createElement(`canvas`),i=r.getContext(`2d`),a=e.getBoundingClientRect(),o=window.devicePixelRatio||2,s=Math.round(a.width),c=Math.round(a.height);r.width=s*o,r.height=c*o,i.scale(o,o),i.fillStyle=getComputedStyle(document.documentElement).getPropertyValue(`--bg-color`).trim()||`#ffffff`,i.fillRect(0,0,s,c);let l=new Image;l.onload=()=>{i.drawImage(l,0,0,s,c),t(r)},l.onerror=n,l.src=ut(e)})}async function ft(e,t){let n=e.querySelector(`svg`);if(!n)return;let r=t.innerHTML;t.innerHTML=`<i class="bi bi-hourglass-split"></i>`;try{(await dt(n)).toBlob(e=>{let n=URL.createObjectURL(e),i=document.createElement(`a`);i.href=n,i.download=`diagram-${Date.now()}.png`,i.click(),URL.revokeObjectURL(n),t.innerHTML=`<i class="bi bi-check-lg"></i>`,setTimeout(()=>{t.innerHTML=r},1500)},`image/png`)}catch(e){console.error(`Mermaid PNG export failed:`,e),t.innerHTML=r}}async function pt(e,t){let n=e.querySelector(`svg`);if(!n)return;let r=t.innerHTML;t.innerHTML=`<i class="bi bi-hourglass-split"></i>`;try{(await dt(n)).toBlob(async e=>{try{await navigator.clipboard.write([new ClipboardItem({"image/png":e})]),t.innerHTML=`<i class="bi bi-check-lg"></i> Copied!`}catch(e){console.error(`Clipboard write failed:`,e),t.innerHTML=`<i class="bi bi-x-lg"></i>`}setTimeout(()=>{t.innerHTML=r},1800)},`image/png`)}catch(e){console.error(`Mermaid copy failed:`,e),t.innerHTML=r}}function mt(e,t){let n=e.querySelector(`svg`);if(!n)return;let r=n.cloneNode(!0),i=new XMLSerializer().serializeToString(r),a=new Blob([i],{type:`image/svg+xml`}),o=URL.createObjectURL(a),s=document.createElement(`a`);s.href=o,s.download=`diagram-${Date.now()}.svg`,s.click(),URL.revokeObjectURL(o);let c=t.innerHTML;t.innerHTML=`<i class="bi bi-check-lg"></i>`,setTimeout(()=>{t.innerHTML=c},1500)}var V=null,H=null;function ht(){let e=document.getElementById(`mermaid-zoom-modal`),t=document.getElementById(`mermaid-modal-diagram`);if(!e.classList.contains(`active`))return;e.classList.remove(`active`),H&&=(H.dispose(),null),t.innerHTML=``,V=null;let n=document.querySelector(`.mermaid-modal-content`);n&&n.classList.remove(`fullscreen`);let r=document.getElementById(`mermaid-modal-fullscreen`);r&&(r.innerHTML=`<i class="bi bi-arrows-fullscreen"></i> Fullscreen`)}function gt(e){let t=e.querySelector(`svg`);if(!t)return;let n=document.getElementById(`mermaid-zoom-modal`),r=document.getElementById(`mermaid-modal-diagram`);H&&=(H.dispose(),null),r.innerHTML=``;let i=t.cloneNode(!0);i.removeAttribute(`width`),i.removeAttribute(`height`),i.style.width=`auto`,i.style.height=`auto`,i.style.maxWidth=`100%`,i.style.maxHeight=`100%`,r.appendChild(i),V=i,n.classList.add(`active`),setTimeout(()=>{H=window.panzoom(i,{maxZoom:10,minZoom:.1,smoothScroll:!0,zoomDoubleClickSpeed:1,bounds:!1})},50)}function _t(){let e=document.getElementById(`mermaid-zoom-modal`);document.getElementById(`mermaid-modal-close`).addEventListener(`click`,ht),e.addEventListener(`click`,function(t){t.target===e&&ht()}),document.getElementById(`mermaid-modal-zoom-in`).addEventListener(`click`,()=>{if(H){let e=H.getTransform();H.smoothZoom(e.x,e.y,1.5)}}),document.getElementById(`mermaid-modal-zoom-out`).addEventListener(`click`,()=>{if(H){let e=H.getTransform();H.smoothZoom(e.x,e.y,.7)}}),document.getElementById(`mermaid-modal-zoom-reset`).addEventListener(`click`,()=>{H&&(H.moveTo(0,0),H.zoomAbs(0,0,1))});let t=document.getElementById(`mermaid-modal-fullscreen`);t&&t.addEventListener(`click`,function(){let e=document.querySelector(`.mermaid-modal-content`);e.classList.toggle(`fullscreen`);let t=e.classList.contains(`fullscreen`);this.innerHTML=t?`<i class="bi bi-fullscreen-exit"></i> Exit`:`<i class="bi bi-arrows-fullscreen"></i> Fullscreen`}),document.getElementById(`mermaid-modal-download-png`).addEventListener(`click`,async function(){if(!V)return;let e=this,t=e.innerHTML;e.innerHTML=`<i class="bi bi-hourglass-split"></i>`;try{(await dt(V)).toBlob(n=>{let r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`diagram-${Date.now()}.png`,i.click(),URL.revokeObjectURL(r),e.innerHTML=`<i class="bi bi-check-lg"></i>`,setTimeout(()=>{e.innerHTML=t},1500)},`image/png`)}catch(n){console.error(`Modal PNG export failed:`,n),e.innerHTML=t}}),document.getElementById(`mermaid-modal-copy`).addEventListener(`click`,async function(){if(!V)return;let e=this,t=e.innerHTML;e.innerHTML=`<i class="bi bi-hourglass-split"></i>`;try{(await dt(V)).toBlob(async n=>{try{await navigator.clipboard.write([new ClipboardItem({"image/png":n})]),e.innerHTML=`<i class="bi bi-check-lg"></i> Copied!`}catch(t){console.error(`Clipboard write failed:`,t),e.innerHTML=`<i class="bi bi-x-lg"></i>`}setTimeout(()=>{e.innerHTML=t},1800)},`image/png`)}catch(n){console.error(`Modal copy failed:`,n),e.innerHTML=t}}),document.getElementById(`mermaid-modal-download-svg`).addEventListener(`click`,function(){if(!V)return;let e=new XMLSerializer().serializeToString(V),t=new Blob([e],{type:`image/svg+xml`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`diagram-${Date.now()}.svg`,r.click(),URL.revokeObjectURL(n)})}function vt(){let e=document.getElementById(`mermaid-zoom-modal`);document.getElementById(`markdown-preview`).querySelectorAll(`.mermaid-container`).forEach(t=>{if(t.querySelector(`.mermaid-toolbar`)||!t.querySelector(`svg`))return;let n=document.createElement(`div`);n.className=`mermaid-toolbar`,n.setAttribute(`aria-label`,`Diagram actions`);let r=document.createElement(`button`);r.className=`mermaid-toolbar-btn`,r.title=`Zoom diagram`,r.setAttribute(`aria-label`,`Zoom diagram`),r.innerHTML=`<i class="bi bi-arrows-fullscreen"></i>`,r.addEventListener(`click`,()=>gt(t));let i=document.createElement(`button`);i.className=`mermaid-toolbar-btn`,i.title=`Download PNG`,i.setAttribute(`aria-label`,`Download PNG`),i.innerHTML=`<i class="bi bi-file-image"></i> PNG`,i.addEventListener(`click`,()=>ft(t,i));let a=document.createElement(`button`);a.className=`mermaid-toolbar-btn`,a.title=`Copy image to clipboard`,a.setAttribute(`aria-label`,`Copy image to clipboard`),a.innerHTML=`<i class="bi bi-clipboard-image"></i> Copy`,a.addEventListener(`click`,()=>pt(t,a));let o=document.createElement(`button`);o.className=`mermaid-toolbar-btn`,o.title=`Download SVG`,o.setAttribute(`aria-label`,`Download SVG`),o.innerHTML=`<i class="bi bi-filetype-svg"></i> SVG`,o.addEventListener(`click`,()=>mt(t,o)),n.appendChild(r),n.appendChild(a),n.appendChild(i),n.appendChild(o),t.appendChild(n),t.addEventListener(`dblclick`,n=>{n.target.closest(`.mermaid-toolbar`)||(e.classList.contains(`active`)?ht():gt(t))})})}function yt(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`?`dark`:`default`;mermaid.initialize({startOnLoad:!1,theme:e,securityLevel:`loose`,flowchart:{useMaxWidth:!0,htmlLabels:!0},fontSize:16})}function bt(){try{yt()}catch(e){console.warn(`Mermaid initialization failed:`,e)}let e={gfm:!0,breaks:!1,pedantic:!1,sanitize:!1,smartypants:!1,xhtml:!1,headerIds:!0,mangle:!1},t=new marked.Renderer;t.code=function(e,t){if(t===`mermaid`){let t=`mermaid-diagram-`+Math.random().toString(36).substr(2,9),n=e;return/^\s*(flowchart|graph)\b/i.test(e)&&(n=e.replace(/(\b\d+\.)\s+/g,`$1&nbsp;`).replace(/(^|[\[\(|]\s*)([-*+])\s+/g,`$1$2&nbsp;`)),`<div class="mermaid-container"><pre class="mermaid" id="${t}">${(e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`))(n)}</pre></div>`}if((t===`plantuml`||t===`puml`)&&window.plantumlEncoder)return`<div class="plantuml-container" style="text-align: center; margin: 1.5em 0;">
...
`),t)}catch(r){return console.warn(`Markdown parsing error, fallback to original parser:`,r),n(e,t)}}}var xt=t({debouncedRender:()=>Tt,renderMarkdown:()=>W,updateDocumentStats:()=>Et,updateTOC:()=>wt}),U=document.getElementById(`markdown-preview`),St=null,Ct=150;function W(){try{let e=n.value,t=marked.parse(e);U.innerHTML=DOMPurify.sanitize(t,{ADD_TAGS:[`mjx-container`],ADD_ATTR:[`id`,`class`,`style`,`data-mxgraph`]}),lt(U),yt();try{let e=U.querySelectorAll(`.mermaid`);e.length>0&&(e.forEach(e=>{e.innerHTML.includes(`\\n`)&&(e.innerHTML=e.innerHTML.replace(/\\n/g,`<br/>`))}),mermaid.run({nodes:Array.from(e),suppressErrors:!0}).then(()=>vt()).catch(e=>{console.warn(`Mermaid rendering failed:`,e),vt()}))}catch(e){console.warn(`Mermaid rendering failed:`,e)}if(window.MathJax)try{typeof MathJax.typesetPromise==`function`?MathJax.typesetPromise([U]).catch(e=>{console.warn(`MathJax typesetting failed:`,e)}):MathJax.startup&&MathJax.startup.promise&&MathJax.startup.promise.then(()=>{typeof MathJax.typesetPromise==`function`&&MathJax.typesetPromise([U]).catch(e=>{console.warn(`MathJax typesetting failed:`,e)})})}catch(e){console.warn(`MathJax rendering failed:`,e)}if(window.GraphViewer)try{window.GraphViewer.processElements()}catch(e){console.warn(`Draw.io GraphViewer rendering failed:`,e)}Et(),ct(),wt()}catch(e){console.error(`Markdown rendering failed:`,e),U.innerHTML=`<div class="alert alert-danger">
              <strong>Error rendering markdown:</strong> ${e.message}
          </div>
          <pre>${n.value}</pre>`}}function wt(){let e=document.getElementById(`toc-tree`);if(!e)return;let t=U.querySelectorAll(`h1, h2, h3, h4, h5, h6`);if(t.length===0){e.innerHTML=`<div class="empty-vault-message">No headings found in document.</div>`;return}e.innerHTML=``,t.forEach((t,n)=>{t.id||=t.textContent.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/(^-|-$)+/g,``)||`heading-`+n;let r=parseInt(t.tagName.substring(1)),i=document.createElement(`div`);i.className=`tree-node`,i.style.paddingLeft=`${(r-1)*16+16}px`,r===1?i.style.fontWeight=`600`:r>2&&(i.style.opacity=`0.8`,i.style.fontSize=`0.85rem`),i.innerHTML=`<div class="tree-node-title" title="${t.textContent}">${t.textContent}</div>`,i.addEventListener(`click`,()=>{t.scrollIntoView({behavior:`smooth`})}),e.appendChild(i)})}function Tt(){clearTimeout(St),St=setTimeout(W,Ct)}function Et(){let e=n.value,t=e.length;l&&(l.textContent=t.toLocaleString());let r=e.trim()===``?0:e.trim().split(/\s+/).length;c&&(c.textContent=r.toLocaleString());let i=Math.ceil(r/200);s&&(s.textContent=i)}function Dt(){let e=window.matchMedia&&window.matchMedia(`(prefers-color-scheme: dark)`).matches;if(document.documentElement.setAttribute(`data-theme`,e?`dark`:`light`),r){r.textContent=``;let t=document.createElement(`i`);t.className=e?`bi bi-sun`:`bi bi-moon`,r.appendChild(t),r.addEventListener(`click`,function(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`?`light`:`dark`;document.documentElement.setAttribute(`data-theme`,e),e===`dark`?r.innerHTML=`<i class="bi bi-sun"></i>`:r.innerHTML=`<i class="bi bi-moon"></i>`,W()})}let t=document.querySelectorAll(`.doc-theme-select`),n=document.getElementById(`markdown-preview`);t.length>0&&n&&t.forEach(e=>{e.addEventListener(`click`,r=>{r.preventDefault(),t.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`);let i=e.getAttribute(`data-theme`);n.className.split(` `).forEach(e=>{e.startsWith(`theme-`)&&n.classList.remove(e)}),i!==`default`&&n.classList.add(`theme-${i}`)})})}function Ot(){let e=document.getElementById(`privacy-notice`),t=document.getElementById(`privacy-dismiss`);e&&!localStorage.getItem(`kido-privacy-dismissed`)&&(e.style.display=`block`),t&&t.addEventListener(`click`,()=>{e.classList.add(`dismissing`),localStorage.setItem(`kido-privacy-dismissed`,`1`),setTimeout(()=>{e.style.display=`none`},300)})}var kt=[],At=document.getElementById(`history-btn`),G=document.getElementById(`history-panel`),K=document.getElementById(`history-overlay`),jt=document.getElementById(`history-close`),q=document.getElementById(`history-list`),Mt=document.getElementById(`history-diff-view`),Nt=document.getElementById(`history-diff-content`),Pt=document.getElementById(`history-diff-title`),Ft=document.getElementById(`history-back`);async function It(){try{let e=await localforage.getItem(b);kt=e?JSON.parse(e):[]}catch{kt=[]}}function Lt(){return kt}function Rt(e){kt=e,localforage.setItem(b,JSON.stringify(e)).catch(e=>console.warn(e))}function zt(){return Date.now().toString(36)+Math.random().toString(36).slice(2,7)}function Bt(e,t){let n=Lt(),r=n.filter(e=>e.tabId===x.activeTabId),i=r.length>0?r[r.length-1]:null,a={id:zt(),tabId:x.activeTabId,title:t||`Untitled`,content:e,timestamp:Date.now(),parentId:i?i.id:null};return n.push(a),n.length>200&&n.splice(0,n.length-200),Rt(n),a}function Vt(){if(!G)return;let e=Lt().filter(e=>!e.tabId||e.tabId===x.activeTabId);Mt.style.display=`none`,q.style.display=`block`;let t=x.tabs.find(e=>e.id===x.activeTabId),n=G.querySelector(`h3`);n&&(n.innerHTML=`<i class="bi bi-clock-history"></i> `+(t?t.title:`Version`)+` History`),e.length===0?q.innerHTML=`<div class="history-empty">No history for this note yet.<br>Share it to start tracking versions.</div>`:(q.innerHTML=e.slice().reverse().map(e=>{let t=new Date(e.timestamp).toLocaleString(),n=e.parentId?`<span class="has-parent"><i class="bi bi-git"></i> has parent</span>`:``,r=e.content?e.content.length+` chars`:``;return`<div class="history-item" data-id="`+e.id+`"><div class="history-item-title">`+(e.title||`Untitled`)+`</div><div class="history-item-meta"><span>`+t+`</span><span>`+r+`</span>`+n+`</div></div>`}).join(``),q.querySelectorAll(`.history-item`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.id;Ut(t)})})),G.style.display=`flex`,K.style.display=`block`}function Ht(){G&&(G.style.display=`none`),K&&(K.style.display=`none`)}function Ut(e){let t=Lt(),n=t.find(t=>t.id===e);if(!n)return;let r=n.parentId?t.find(e=>e.id===n.parentId):null;if(q.style.display=`none`,Mt.style.display=`flex`,!r){Pt.textContent=`First version — `+(n.title||`Untitled`),Nt.innerHTML=n.content.split(`
`).map(e=>`<div class="diff-line diff-added">+ `+Wt(e)+`</div>`).join(``);return}Pt.textContent=`Changes from previous version`,typeof Diff<`u`&&Diff.diffLines?Nt.innerHTML=Diff.diffLines(r.content||``,n.content||``).map(e=>{let t=e.value.split(`
`).filter((e,t,n)=>t<n.length-1||e!==``),n=e.added?`diff-added`:e.removed?`diff-removed`:`diff-unchanged`,r=e.added?`+ `:e.removed?`- `:`  `;return t.map(e=>`<div class="diff-line `+n+`">`+r+Wt(e)+`</div>`).join(``)}).join(``):Nt.innerHTML=`<div class="history-empty">Diff library not loaded</div>`}function Wt(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}function Gt(){At&&At.addEventListener(`click`,Vt),jt&&jt.addEventListener(`click`,Ht),K&&K.addEventListener(`click`,Ht),Ft&&Ft.addEventListener(`click`,()=>{Mt.style.display=`none`,q.style.display=`block`});let e=document.getElementById(`history-resize-handle`);if(e&&G){let t=!1,n=0,r=0;e.addEventListener(`mousedown`,i=>{t=!0,n=i.clientX,r=G.offsetWidth,e.classList.add(`dragging`),document.body.style.cursor=`col-resize`,document.body.style.userSelect=`none`,i.preventDefault()}),document.addEventListener(`mousemove`,e=>{if(!t)return;let i=n-e.clientX,a=Math.min(Math.max(r+i,280),window.innerWidth*.8);G.style.width=a+`px`}),document.addEventListener(`mouseup`,()=>{t&&(t=!1,e.classList.remove(`dragging`),document.body.style.cursor=``,document.body.style.userSelect=``)})}}function Kt(){let e=null,t=null;n.addEventListener(`input`,function(){Tt(),clearTimeout(t),t=setTimeout(R,500),clearTimeout(e),e=setTimeout(()=>{let e=n.value;if(!e.trim())return;let t=Lt().filter(e=>e.tabId===x.activeTabId),r=t.length>0?t[t.length-1]:null;if(!r||Math.abs(e.length-(r.content||``).length)>=20){let t=x.tabs.find(e=>e.id===x.activeTabId);Bt(e,t?t.title:`Untitled`)}},5e3)}),n.addEventListener(`keydown`,function(e){if(e.key===`Tab`){e.preventDefault();let t=this.selectionStart,n=this.selectionEnd,r=this.value;this.value=r.substring(0,t)+`  `+r.substring(n),this.selectionStart=this.selectionEnd=t+2,this.dispatchEvent(new Event(`input`))}})}var qt=32e3;function Jt(e){let t=pako.deflate(new TextEncoder().encode(e)),n=32768,r=``;for(let e=0;e<t.length;e+=n)r+=String.fromCharCode.apply(null,t.subarray(e,e+n));return btoa(r).replace(/\+/g,`-`).replace(/\//g,`_`).replace(/=+$/,``)}function Yt(e){let t=decodeURIComponent(e).replace(/-/g,`+`).replace(/_/g,`/`);for(;t.length%4;)t+=`=`;let n=atob(t),r=Uint8Array.from(n,e=>e.charCodeAt(0));return new TextDecoder().decode(pako.inflate(r))}function Xt(e){let t=x.tabs.find(e=>e.id===x.activeTabId),r=t?t.title:`Untitled`;Bt(n.value,r);let i=n.value,a;try{a=Jt(i)}catch(e){console.error(`Share encoding failed:`,e),alert(`Failed to encode content for sharing: `+e.message);return}let o=window.location.origin+window.location.pathname+`#share=`+a+`&mode=`+O,s=o.length>qt,c=e.innerHTML;function l(){s||(window.location.hash=`share=`+a+`&mode=`+O),e.innerHTML=`<i class="bi bi-check-lg"></i> Copied!`,setTimeout(()=>{e.innerHTML=c},2e3)}if(navigator.clipboard&&window.isSecureContext)navigator.clipboard.writeText(o).then(l).catch(()=>{});else try{let e=document.createElement(`textarea`);e.value=o,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),l()}catch{}}function Zt(){let e=document.getElementById(`share-button`),t=document.getElementById(`mobile-share-button`);e&&e.addEventListener(`click`,function(){Xt(e)}),t&&t.addEventListener(`click`,function(){Xt(t)}),window.addEventListener(`hashchange`,()=>{window.location.hash.startsWith(`#share=`)&&en()})}function Qt(){if(typeof pako>`u`)return console.error(`pako is undefined. Cannot load shared content.`),null;let e=``,t=window.location.hash;if(t.startsWith(`#share=`))e=t.slice(7);else{let t=window.location.href.match(/(?:#|%23)share=([^&?]*)/);t&&(e=t[1])}if(!e)return null;let n=e.match(/^[A-Za-z0-9\-_]+/);if(n)e=n[0];else return null;try{return Yt(e)}catch(e){return console.error(`Failed to decode shared content:`,e),alert(`The shared URL could not be decoded. It may be corrupted or incomplete.`),null}}function $t(){let e=window.location.hash.match(/(?:&|\?)mode=([a-zA-Z]+)/);return e?e[1]:`split`}function en(){let e=Qt();if(e===null)return;let t=I(e,`Shared Note`);x.tabs.push(t),x.activeTabId=t.id,n.value=e,j($t()),W(),M(x.tabs),N(x.activeTabId),L(x.tabs,x.activeTabId)}function tn(){let e=document.getElementById(`close-all-tabs-btn`);e&&e.addEventListener(`click`,function(){at()});let t=document.getElementById(`tab-reset-btn`);t&&t.addEventListener(`click`,function(){it()});let n=document.getElementById(`logo-home`);n&&n.addEventListener(`click`,function(){it()})}function nn(){document.addEventListener(`keydown`,async function(e){if((e.ctrlKey||e.metaKey)&&e.key===`s`){e.preventDefault();let t=x.tabs.find(e=>e.id===x.activeTabId);if(x.localVaultMode&&x.vaultDirHandle&&t)if(t.handle){await R(!0);let e=document.getElementById(`exportDropdown`);if(e){let t=e.innerHTML;e.innerHTML=`<i class="bi bi-check2"></i> <span class="btn-label">Saved</span>`,setTimeout(()=>{e.innerHTML=t},1500)}}else try{let e=prompt(`Save to Vault as:`,t.title+`.md`);if(e){e.endsWith(`.md`)||(e+=`.md`);let r;try{if(r=await x.vaultDirHandle.getFileHandle(e,{create:!1}),!confirm(`File "`+e+`" already exists. Overwrite?`))return;r=await x.vaultDirHandle.getFileHandle(e,{create:!0})}catch{r=await x.vaultDirHandle.getFileHandle(e,{create:!0})}let i=await r.createWritable();await i.write(t.content||n.value),await i.close(),t.handle=r,t.title=e.replace(/\.md$/i,``),t.id=`/`+e,L(x.tabs,x.activeTabId),await C();let a=document.getElementById(`exportDropdown`);if(a){let e=a.innerHTML;a.innerHTML=`<i class="bi bi-check2"></i> <span class="btn-label">Saved</span>`,setTimeout(()=>{a.innerHTML=e},1500)}}}catch(e){alert(`Error saving to vault: `+e.message)}else{let e=document.getElementById(`export-md`);e&&e.click()}}if((e.ctrlKey||e.metaKey)&&e.key===`c`){let t=document.activeElement,n=t&&(t.tagName===`TEXTAREA`||t.tagName===`INPUT`),r=window.getSelection&&window.getSelection().toString().trim().length>0;if(!n&&!r){e.preventDefault();let t=document.getElementById(`copy-markdown-button`);t&&t.click()}}(e.ctrlKey||e.metaKey)&&e.shiftKey&&e.key===`S`&&(e.preventDefault(),O===`split`&&Te()),(e.ctrlKey||e.metaKey)&&e.key===`t`&&(e.preventDefault(),B()),(e.ctrlKey||e.metaKey)&&e.key===`w`&&(e.preventDefault(),et(x.activeTabId)),e.key===`Escape`&&ht()})}function rn(e){let t=new FileReader;t.onload=function(t){B(t.target.result,e.name.replace(/\.md$/i,``));let n=document.getElementById(`dropzone`);n&&(n.style.display=`none`)},t.readAsText(e)}var J=document.getElementById(`dropzone`),Y=document.getElementById(`close-dropzone`),an=document.getElementById(`file-input`);function on(){if(!J)return;[`dragenter`,`dragover`].forEach(t=>{J.addEventListener(t,e,!1)}),[`dragleave`,`drop`].forEach(e=>{J.addEventListener(e,t,!1)});function e(){J.classList.add(`active`)}function t(){J.classList.remove(`active`)}J.addEventListener(`drop`,n,!1),J.addEventListener(`click`,function(e){Y&&e.target!==Y&&!Y.contains(e.target)&&an&&an.click()}),Y&&Y.addEventListener(`click`,function(e){e.stopPropagation(),J.style.display=`none`});function n(e){let t=e.dataTransfer.files;if(t.length){let e=t[0];e.type===`text/markdown`||e.name.endsWith(`.md`)||e.name.endsWith(`.markdown`)?rn(e):alert(`Please upload a Markdown file (.md or .markdown)`)}}}function X(e,t,n){let r,i=new Promise((e,i)=>{r=setTimeout(()=>i(Error(n)),t)});return Promise.race([e,i]).finally(()=>clearTimeout(r))}var sn={a4Width:210,a4Height:297,margin:15,contentWidth:180,contentHeight:267,windowWidth:1e3,scale:2};function cn(e){let t=[];return e.querySelectorAll(`img`).forEach(e=>t.push({element:e,type:`img`})),e.querySelectorAll(`svg`).forEach(e=>t.push({element:e,type:`svg`})),e.querySelectorAll(`pre`).forEach(e=>t.push({element:e,type:`pre`})),e.querySelectorAll(`table`).forEach(e=>t.push({element:e,type:`table`})),t}function ln(e,t){let n=t.getBoundingClientRect();return e.map(e=>{let t=e.element.getBoundingClientRect(),r=t.top-n.top,i=t.height;return{element:e.element,type:e.type,top:r,height:i,bottom:r+i}})}function un(e,t,n){let r=(t||793)*(n.contentHeight/n.contentWidth),i=[];if(r<10)return{boundaries:i,pageHeightPx:0};let a=r;for(;a<e;)i.push(a),a+=r;return{boundaries:i,pageHeightPx:r}}function dn(e,t){if(!e||e.length===0||!t||t.length===0)return[];let n=[];for(let r of e){let e=0;for(let n=0;n<t.length&&r.top>=t[n];n++)e=n+1;let i=0;for(let e=0;e<t.length&&r.bottom>t[e];e++)i=e+1;if(i>e){let i=t[e]||t[0];n.push({element:r.element,type:r.type,top:r.top,height:r.height,splitPageIndex:e,overflowAmount:r.bottom-i})}}return n}function fn(e){try{let t=cn(e),n=ln(t,e),{boundaries:r,pageHeightPx:i}=un(e.scrollHeight,e.offsetWidth,sn),a=dn(n,r);return{totalElements:t.length,splitElements:a,pageCount:r.length+1,pageBoundaries:r,pageHeightPx:i}}catch(e){return console.error(`Page-break analysis failed:`,e),{totalElements:0,splitElements:[],pageCount:1,pageBoundaries:[],pageHeightPx:0}}}var pn=.3;function mn(e,t){let n=[],r=[];for(let i of e)i.height<=t?n.push(i):r.push(i);return{fittingElements:n,oversizedElements:r}}function hn(e,t){for(let n of e){let e=(n.splitPageIndex+1)*t,r=e-n.top;if(r/t>pn&&n.height*.9<=r)continue;let i=e-n.top+5,a=n.element;n.type===`svg`&&n.element.parentElement&&(a=n.element.parentElement);let o=parseFloat(a.style.marginTop)||0;a.style.marginTop=`${o+i}px`}}function gn(e,t,n=10){let r=0,i,a=-1;do{if(i=fn(e),!i.pageHeightPx||i.splitElements.length===0||i.splitElements.length===a)break;a=i.splitElements.length;let{fittingElements:t,oversizedElements:n}=mn(i.splitElements,i.pageHeightPx);if(i.oversizedElements=n,t.length===0)break;hn(t,i.pageHeightPx),r++}while(r<n);return i}var _n=.5;function vn(e,t,n=5){let r=(t-n)/e,i=!1;return r<_n&&(r=_n,i=!0),{scaleFactor:r,wasClampedToMin:i}}function yn(e,t,n){let r=e.offsetHeight;n===`svg`&&(e.style.maxWidth=`none`),e.style.transform=`scale(${t})`,e.style.transformOrigin=`top left`;let i=r*t;e.style.marginBottom=`-${r-i}px`}function bn(e,t){if(!(!e||e.length===0))for(let n of e){let{scaleFactor:e}=vn(n.height,t);yn(n.element,e,n.type)}}async function xn(e,t,n){try{let r=t.innerHTML;t.innerHTML=`<i class="bi bi-hourglass-split"></i> Generating...`,t.disabled=!0;let i=document.createElement(`div`);i.style.position=`fixed`,i.style.top=`50%`,i.style.left=`50%`,i.style.transform=`translate(-50%, -50%)`,i.style.padding=`15px 20px`,i.style.backgroundColor=`rgba(0, 0, 0, 0.7)`,i.style.color=`white`,i.style.borderRadius=`5px`,i.style.zIndex=`9999`,i.style.textAlign=`center`;let a=document.createElement(`div`);a.textContent=`Generating PDF...`,i.appendChild(a),document.body.appendChild(i);let o=window.marked?window.marked.parse(e):marked.parse(e),s=DOMPurify.sanitize(o,{ADD_TAGS:[`mjx-container`,`svg`,`path`,`g`,`marker`,`defs`,`pattern`,`clipPath`],ADD_ATTR:[`id`,`class`,`style`,`viewBox`,`d`,`fill`,`stroke`,`transform`,`marker-end`,`marker-start`]}),c=document.createElement(`div`);c.className=`markdown-body pdf-export`,c.innerHTML=s,c.style.padding=`20px`,c.style.width=`210mm`,c.style.minWidth=`210mm`,c.style.maxWidth=`none`,c.style.margin=`0 auto`,c.style.fontSize=`14px`,c.style.position=`fixed`,c.style.left=`-9999px`,c.style.top=`0`,c.style.backgroundColor=n===`dark`?`#0d1117`:`#ffffff`,c.style.color=n===`dark`?`#c9d1d9`:`#24292e`,document.body.appendChild(c),await new Promise(e=>setTimeout(e,200));try{window.mermaid&&await X(window.mermaid.run({nodes:c.querySelectorAll(`.mermaid`),suppressErrors:!0}),3e3,`Mermaid rendering timed out`)}catch(e){console.warn(`Mermaid rendering issue:`,e)}if(window.MathJax){try{typeof MathJax.typesetPromise==`function`?await X(MathJax.typesetPromise([c]),3e3,`MathJax typesetting timed out`):MathJax.startup&&MathJax.startup.promise&&(await X(MathJax.startup.promise,3e3,`MathJax startup timed out`),typeof MathJax.typesetPromise==`function`&&await X(MathJax.typesetPromise([c]),3e3,`MathJax typesetting timed out`))}catch(e){console.warn(`MathJax rendering issue:`,e)}c.querySelectorAll(`mjx-assistive-mml`).forEach(e=>{e.style.display=`none`,e.style.visibility=`hidden`,e.style.position=`absolute`,e.style.width=`0`,e.style.height=`0`,e.style.overflow=`hidden`,e.remove()}),c.querySelectorAll(`script[type*="math"], script[type*="tex"]`).forEach(e=>e.remove())}await new Promise(e=>setTimeout(e,500));let l=gn(c,sn);l.oversizedElements&&l.pageHeightPx&&bn(l.oversizedElements,l.pageHeightPx);let u=new window.jspdf.jsPDF({orientation:`portrait`,unit:`mm`,format:`a4`,compress:!0,hotfixes:[`px_scaling`]}),d=u.internal.pageSize.getWidth(),f=u.internal.pageSize.getHeight(),p=d-30,m=window.getComputedStyle;window.getComputedStyle=function(e,t){let n=m.call(window,e,t);return new Proxy(n,{get(e,t){if(t===`getPropertyValue`)return function(t){let n=e.getPropertyValue.call(e,t);return typeof n==`string`&&/(oklch|oklab|lab|lch)\([^)]+\)/i.test(n)?n.replace(/(oklch|oklab|lab|lch)\([^)]+\)/gi,`rgb(0, 0, 0)`):n};let n=Reflect.get(e,t);return typeof n==`function`?n.bind(e):typeof n==`string`&&/(oklch|oklab|lab|lch)\([^)]+\)/i.test(n)?n.replace(/(oklch|oklab|lab|lch)\([^)]+\)/gi,`rgb(0, 0, 0)`):n}})};let h;try{h=await X(window.html2canvas(c,{scale:2,useCORS:!0,allowTaint:!0,logging:!1,windowWidth:1e3,windowHeight:c.scrollHeight}),1e4,`html2canvas rendering timed out`)}finally{window.getComputedStyle=m}let g=h.width/p;if(g<=0||!isFinite(g))throw Error(`Invalid canvas scale factor (width: ${h.width}, contentWidth: ${p})`);let _=h.height/g,v=Math.ceil(_/(f-30));if(v<=0||!isFinite(v))throw Error(`Invalid page count computed: ${v}`);for(let e=0;e<v;e++){e>0&&u.addPage();let t=e*(f-30)*g,n=Math.min(h.height-t,(f-30)*g),r=n/g,i=document.createElement(`canvas`);i.width=h.width,i.height=n,i.getContext(`2d`).drawImage(h,0,t,h.width,n,0,0,h.width,n);let a=i.toDataURL(`image/png`);u.addImage(a,`PNG`,15,15,p,r)}u.save(`document.pdf`),a.textContent=`Download successful!`,setTimeout(()=>document.body.removeChild(i),1500),document.body.removeChild(c),t.innerHTML=r,t.disabled=!1}catch(e){console.error(`PDF export failed:`,e),alert(`PDF export failed: `+e.message),t.innerHTML=`<i class="bi bi-file-earmark-pdf"></i> Export`,t.disabled=!1;let n=document.querySelector(`div[style*="Generating PDF"]`);n&&document.body.removeChild(n)}}function Sn(){let e=document.getElementById(`export-md`),t=document.getElementById(`export-html`),r=document.getElementById(`export-pdf`),i=document.getElementById(`copy-markdown-button`);e.addEventListener(`click`,function(){try{let e=new Blob([n.value],{type:`text/markdown;charset=utf-8`});saveAs(e,`document.md`)}catch(e){console.error(`Export failed:`,e),alert(`Export failed: `+e.message)}}),t.addEventListener(`click`,function(){try{let e=n.value,t=marked.parse(e),r=DOMPurify.sanitize(t,{ADD_TAGS:[`mjx-container`],ADD_ATTR:[`id`,`class`,`style`]}),i=document.documentElement.getAttribute(`data-theme`)===`dark`,a=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
